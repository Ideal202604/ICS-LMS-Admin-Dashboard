...
const questionPoolContent = {
  title: "Question Pool",
  description: "Create and manage your Question Pool",
};

export const QuestionPoolContentSection = (): JSX.Element => {
  return (
