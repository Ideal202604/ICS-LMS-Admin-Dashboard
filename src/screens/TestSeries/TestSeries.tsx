...
import { TestSeriesContentSection } from "./sections/TestSeriesContentSection";
import { AppLayout } from "../../components/shared";

export const TestSeries = (): JSX.Element => {
  return (
    <AppLayout className="bg-[#f8f8f8]">
      <section className="flex min-w-0 flex-1 flex-col px-2 pb-8 pt-3 sm:px-3 md:px-4 lg:px-6">
        <TestSeriesContentSection />
        <div className="mt-6 flex w-full justify-end">
          ...
          >
            <img
              className="h-5 w-5"
              alt="Plus"
              src="https://c.animaapp.com/mojup4bdN4yfrg/img/plus.svg"
            />
