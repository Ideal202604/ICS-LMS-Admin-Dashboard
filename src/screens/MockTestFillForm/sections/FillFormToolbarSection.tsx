...
export const FillFormToolbarSection = (): JSX.Element => {
  ...
  return (
    <header className="relative z-10 w-full bg-white shadow-[0px_4px_4px_#00000040] animate-fade-in">
      <div className="mx-auto flex w-full max-w-[1440px] flex-col">
        {/* Top bar */}
        <div className="flex min-h-[88px] items-start justify-between gap-4 px-8 pb-1.5 pt-2.5 max-sm:px-4">
          <div className="flex shrink-0 items-start">
            <img
              className="h-[60px] w-auto cursor-pointer object-contain transition-opacity duration-200 hover:opacity-80"
              alt="ICS Global"
              src="https://c.animaapp.com/moqqfoy3vJwvbZ/img/ics-png--1--1.png"
              onClick={() => navigate("/mock-test")}
            />
          </div>
          <div className="flex flex-1 items-center justify-end gap-3 pt-1 max-sm:gap-2">
        ...
        <nav
          ...
          className="flex min-h-[46px] items-center gap-8 px-8 pb-2 max-sm:gap-4 max-sm:px-4"
        >
          <Button
            type="button"
            variant="ghost"
