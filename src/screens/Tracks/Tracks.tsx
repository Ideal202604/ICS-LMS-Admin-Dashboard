...
import { TracksManagementPanelSection } from "./sections/TracksManagementPanelSection";
        ...
        <div className="mt-6 flex justify-end">
          ...
          >
            <img
              className="h-5 w-5"
              alt="Plus"
              src="https://c.animaapp.com/mojz9q69igBtes/img/plus.svg"
            />
            <span className="[font-family:'Roboto',Helvetica] text-base font-medium leading-6 tracking-[0] whitespace-nowrap">
              Create
            </span>
          </Button>
        </div>
