...
import { MoreProductsOverviewSection } from "./sections/MoreProductsOverviewSection";

export const MoreProducts = (): JSX.Element => {
  return (
    <AppLayout className="bg-white">
      <section className="flex min-w-0 flex-1 flex-col px-[10px] pt-5 pb-8">
        <MoreProductsOverviewSection />
        <div className="mt-6 flex justify-end">
          ...
          >
            <img
              className="h-5 w-5"
              alt="Plus"
              src="https://c.animaapp.com/mok01ddbXGAEQq/img/plus.svg"
            />
