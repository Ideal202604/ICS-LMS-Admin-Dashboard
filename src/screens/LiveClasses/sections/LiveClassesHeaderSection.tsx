...
export const LiveClassesHeaderSection = (): JSX.Element => {
  return (
      ...
      <div className="flex h-[84px] w-full items-center justify-between gap-4 px-4 sm:px-5 lg:px-8">
        <div className="flex min-w-0 items-center">
          <div className="flex h-[84px] w-[120px] items-center justify-center bg-[#0957a1] sm:w-[154px]">
            <img
              ...
              alt="ICS"
              src="https://c.animaapp.com/moju1bkbWY8iET/img/avatar.svg"
            />
          </div>
          <button
            type="button"
          ...
          >
            <img
              ...
              src="https://c.animaapp.com/moju1bkbWY8iET/img/vector.svg"
            />
          </button>
        </div>
        ...
        >
          {actionButtons.map((item) => (
            ...
            >
              <span className="[font-family:'Roboto',Helvetica]">
                {item.label}
              </span>
            </Button>
          ))}
          ...
          >
            <img
              className="h-5 w-5"
              alt="Help circle"
              src="https://c.animaapp.com/moju1bkbWY8iET/img/help-circle.svg"
            />
          ...
          >
            <img
              className="h-6 w-6"
              alt="Notifications"
              src="https://c.animaapp.com/moju1bkbWY8iET/img/frame.svg"
            />
          </button>
